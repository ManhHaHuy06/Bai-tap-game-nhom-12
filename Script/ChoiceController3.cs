...
public class ChoiceController3 : MonoBehaviour
{
    public Button optionButton1; // Nút lựa chọn 1
    public Button optionButton2; // Nút lựa chọn 2
    public Button optionButton3; // Nút lựa chọn 3
    ...
    private void Start()
    {
        ...
        optionButton3.onClick.AddListener(OnOption2Selected);
    ...
    public void OnOption1Selected()
    {
        ...
        SceneManager.LoadScene("S1.10"); // Thay thế với tên cảnh bạn muốn
    }

    public void OnOption2Selected()
    {
        // Chuyển đến cảnh cho lựa chọn 2
        SceneManager.LoadScene("S1.11"); // Thay thế với tên cảnh bạn muốn
    }
    public void OnOption3Selected()
    {
        // Chuyển đến cảnh cho lựa chọn 3
        SceneManager.LoadScene("S1.11"); // Thay thế với tên cảnh bạn muốn
    }
}
